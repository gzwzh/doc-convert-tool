...
RPMS 或 DEBS 目录中分别还包含名为 libreoffice24.8-freedesktop-menus-24.8.0.1-1.noarch.rpm (或者 libreoffice24.8-debian-menus_24.8.0.1-1_all.deb 或类似的) 的软件包。该软件包可供所有支持 Freedesktop.org 规范/推荐 (https://en.wikipedia.org/wiki/Freedesktop.org) 的 Linux 发行版使用，也可在前文说明中未提及的其他 Linux 发行版中安装。
...
我们希望您能够愉快地使用新的 LibreOffice 24.8 并在线加入我们。

...
Die folgenden Befehle installieren LibreOffice inklusive Desktopintegration (sie können einfach per Kopieren-und-Einfügen in ein Terminal übertragen, anstatt abgetippt werden):
...
Wechseln Sie jetzt in das Verzeichnis, das durch den Entpackvorgang erzeugt wurde. Für ein deutsches Sprachpaket auf einem 32-Bit-Debian-basierten System werden folgende Verzeichnisse erstellt: LibreOffice_ plus Informationen zur Version und Linux_x86_langpack-deb_de.
...
Wir hoffen, dass Sie Spaß bei der Arbeit mit dem neuen LibreOffice 24.8 haben und sich uns online anschließen.

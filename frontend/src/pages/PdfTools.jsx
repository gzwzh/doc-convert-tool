...
function PdfTools() {
  ...
  useEffect(() => {
    if (categoryData && categoryData.length > 0) {
      // Find PDF converter section
      const pdfSection = categoryData.find(section => section.name === 'PDF 转换器');
      setActiveSection(pdfSection || categoryData[0]);
    } else {
        navigate('/');
    }
                ...
                {activeSection.tools.map((tool) => (
                  ...
                  >
                    <div className="card-icon-wrapper">
                      <div className="file-icon source">PDF</div>
                    ...
                    <div className="card-content">
                      ...
                      <div className="card-tags">
                        <span className="tag">PDF TOOLS</span>
                      </div>

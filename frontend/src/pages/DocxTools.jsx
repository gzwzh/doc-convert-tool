...
function DocxTools() {
  ...
  useEffect(() => {
    if (categoryData && categoryData.length > 0) {
      // Find DOCX converter section
      const docxSection = categoryData.find(section => section.name === 'DOCX 转换器');
      setActiveSection(docxSection || categoryData[0]);
    } else {
        navigate('/');
    }
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="card-tags">
                        <span className="tag">DOCX TOOLS</span>
                      </div>

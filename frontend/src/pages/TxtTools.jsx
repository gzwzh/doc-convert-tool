...
function TxtTools() {
  ...
  useEffect(() => {
    if (categoryData && categoryData.length > 0) {
      // Find TXT converter section
      const txtSection = categoryData.find(section => section.name === 'TXT 转换器');
      setActiveSection(txtSection || categoryData[0]);
    } else {
        navigate('/');
    }
                ...
                {activeSection.tools.map((tool) => (
                  ...
                  >
                    <div className="card-icon-wrapper">
                      <div className="file-icon source">TXT</div>
                    ...
                    <div className="card-content">
                      ...
                      <div className="card-tags">
                        <span className="tag">TXT 工具</span>
                      </div>
